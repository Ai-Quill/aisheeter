...
var API_ENDPOINTS = {
  ...
  AGENT_WORKFLOW_FEEDBACK: '/api/agent/workflow-feedback',  // Execution outcome tracking
  AGENT_PROFILE: '/api/agent/profile',            // Sheet profiling
  AGENT_CHAIN_STATE: '/api/agent/chain-state',    // Chain state persistence (DB-backed)
  AGENT_FIX_FORMULA: '/api/agent/fix-formula',    // Formula self-correction via AI
 ...
 */
var DEFAULT_MODELS = {
  CHATGPT: 'gpt-5.4-nano',       // $0.20/$1.25 per MTok - cheapest GPT-5.4
  ...
  GEMINI: 'gemini-2.5-flash'    // $0.30/$2.50 per MTok - fast and cost-effective
};
