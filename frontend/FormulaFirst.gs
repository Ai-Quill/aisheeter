...
function evaluateFormulaFirst(context) {
  ...
  // Let AI decide with FULL context - no hardcoded rejections
...
function evaluateWithAI(context) {
  ...
  var parsed = parseModelSelection(getAgentModel() || 'GEMINI');
...
// getAgentModel() is defined in Agent.gs — removed duplicate here
